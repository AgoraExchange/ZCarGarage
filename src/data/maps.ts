...
export const DEFAULT_MAPS: TuneMap[] = [
  ...
  },
  {
    id: "drift",
    name: "Drift Spec",
    description: "Snappy throttle response, anti-lag, high rev hang for clutch kicks.",
    octane: 93,
    power: 388,
    torque: 302,
    revLimit: 7800,
    ...
    afrTarget: 12.9,
    ignitionAdvance: 24,
    fuel: buildTable(12.7, -1.3, -3.1),
    ignition: buildTable(24, 14, -9),
  },
  {
    id: "widowmaker",
    name: "Widowmaker 850",
    description: "Built VQ37 · twin-turbo · meth injection. 850whp launch map. Strap in.",
    octane: "Race",
    power: 850,
    torque: 690,
    revLimit: 8200,
    ...
    afrTarget: 11.4,
    ignitionAdvance: 18,
    fuel: buildTable(11.2, -1.6, -3.6, 0.35),
    ignition: buildTable(18, 10, -12, 0.3),
  },
  {
    id: "valet",
    name: "Valet Mode",
